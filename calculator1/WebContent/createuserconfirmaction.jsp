...
<meta charset="utf-8">
<title>createuserconfirmaction画面</title>
<style type="text/css">
body {
	margin: 0;
	padding: 0;
			...
			<h3>入力された内容をご確認ください</h3>
				<table>
					...
					<tr>
						...
						<td><s:property value="session.birthmonth" /><span>月</span></td>
						<td><s:property value="session.birthday" /><span>日</span></td>
					</tr>
					<tr>
						<td>性別</td>
